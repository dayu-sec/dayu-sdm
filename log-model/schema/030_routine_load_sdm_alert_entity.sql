...
-- __KAFKA_BROKERS__ 由 apply_prod_schema.sh 注入；topic=sdm_alert_entity 固定。
-- 时间：Unix 毫秒/秒自适应，timezone=Etc/UTC，num_as_string=true。
...
FROM KAFKA(
  ...
  "property.group.id"="sdm_alert_entity_load_v1", "property.kafka_default_offsets"="OFFSET_END"
);
