...
事件事实：终端病毒检测——检出 Trojan.Win32.Emotet.BE（md5=787b03feb0bd3bbf3be3f5aeddf8c64d），路径 `C:\Users\test-user\Desktop\FD样本\...`，handle_result=未处理的病毒，handle_mode=manual。

- 主体：受感染终端 → `roles.source.host{name=TEST-PC-01}`
...
- 原始样本：`log-model/examples/360/` 第 4 个非空行。
