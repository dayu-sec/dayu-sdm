...
事件事实：探针邮件会话（logtype=imap）——用户 xjj_ser@sip.com 访问 IMAP 服务 203.0.113.204:143，邮件 mail_3。
...
| `from` | `\"xjj1@sip.com\" <xjj1@sip.com>` | `facets_obj.email.from` | `confirmed` |
...
| `msg_id` | `<201809181946228522042@sip.com>` | `facets_obj.email.message_id` | `confirmed` |
| `receiveds` | `from pc-PC ([192.0.2.186])\t(envelope-sender <xjj1@sip.com>)\tby 203.0.113.204 with ESMTP\tfor <xjj_ser@sip.com>; Tue, 18 Sep 2018 19:46:26 +0800` | `extensions_obj.source_private.receiveds` | `source_private` |
...
| `to` | `xjj_ser <xjj_ser@sip.com>` | `facets_obj.email.to` | `confirmed` |
...
| `user` | `xjj_ser@sip.com` | `roles_obj.source.user.name` | `confirmed` |
