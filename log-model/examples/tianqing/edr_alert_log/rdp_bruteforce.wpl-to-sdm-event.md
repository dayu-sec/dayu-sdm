...
| `mac` | "00-50-56-81-E8-1C" | `roles.target.host.mac` | `roles_obj.target.host.mac` | "00:50:56:81:e8:1c" | 按当前 expected 事件结构映射 |
...
| `roles.target.host.mac` | `projection` | `mac` | "00:50:56:81:e8:1c" | `—` | confirmed；按当前 expected 事件结构映射 |
