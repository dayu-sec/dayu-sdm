...
| `mac` | "00-00-5E-00-53-BB" | `roles.target.host.mac` | `roles_obj.target.host.mac` | "00:00:5E:00:53:7B" | 按当前 expected 事件结构映射 |
...
| `roles.target.host.mac` | `projection` | `mac` | "00:00:5E:00:53:7B" | `—` | confirmed；按当前 expected 事件结构映射 |
