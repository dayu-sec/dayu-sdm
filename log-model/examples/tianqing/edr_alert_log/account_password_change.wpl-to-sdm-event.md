...
| `description_i18n/zh_CN` | "发现用户\"DESKTOP-EX04$\"修改了用户\"NetUser\"的密码." | `source_finding.description` | `source_finding_obj.description` | "发现用户\"DESKTOP-EX04$\"修改了用户\"NetUser\"的密码." | 按当前 expected 事件结构映射 |
...
| `description` | "发现用户\"DESKTOP-EX04$\"修改了用户\"NetUser\"的密码." | 当前事件未采用该字段；空值、哨兵、机械重复或非检索上下文不落库，原值保留在 raw_msg |
...
| `description_i18n/zh_TW` | "發現使用者\"DESKTOP-EX04$\"修改了使用者\"NetUser\"的密碼." | 当前事件未采用该字段；空值、哨兵、机械重复或非检索上下文不落库，原值保留在 raw_msg |
| `description_i18n/en_US` | "It was found that user \"DESKTOP-EX04$\" changed the password of user \"NetUser\"." | 当前事件未采用该字段；空值、哨兵、机械重复或非检索上下文不落库，原值保留在 raw_msg |
...
| `source_finding.description` | `projection` | `description_i18n/zh_CN` | "发现用户\"DESKTOP-EX04$\"修改了用户\"NetUser\"的密码." | `—` | confirmed；按当前 expected 事件结构映射 |
