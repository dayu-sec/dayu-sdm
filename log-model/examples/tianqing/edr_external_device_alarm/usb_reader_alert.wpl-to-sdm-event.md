...
| `mac` | "00-00-5E-00-53-52" | `roles.target.host.mac` | `roles_obj.target.host.mac` | 受管终端 MAC |
...
| `roles.target.host.mac` | `projection` | `mac` | "00-00-5E-00-53-52" | `—` | confirmed；受管终端 MAC |
