...
| `extensions.source_private.request_targets` | `transform` | `uri` | `parse_uri_list(wpl.uri,entry_prefix='/')` -> ["/login?url=http://sdm.example.internal/\"and sleep(5) and \"1", "/login?url=http://sdm.example.internal/'and sleep(5) and '1", "/login?url=http://sdm.example.internal/ and sleep(5)", "/apis/login", "/api/strategys?pageSize=10&pageNumber=1&type=2&query=123''and sleep(5) and '1", "/api/strategys?pageSize=10&pageNumber=1&type=2&query=123'\"and sleep(5) and \"1", "/api/strategys?pageSize=10&pageNumber=1&type=2&query=123' and sleep(5)", "/api/strategys/ME454286696117313536/components?pageSize=10&pageNumber=1&type=2&query=123'and sleep(5) and '1", "/api/strategys/ME454286696117313536/components?pageSize=10&pageNumber=1&type=2&query=123\"and sleep(5) and \"1", "/api/strategys/ME454286696117313536/components?pageSize=10&pageNumber=1&type=2&query=123 and sleep(5)"] | `preserve_raw_and_review` | confirmed；按条目前导斜杠识别边界；不拼造完整 URL |
