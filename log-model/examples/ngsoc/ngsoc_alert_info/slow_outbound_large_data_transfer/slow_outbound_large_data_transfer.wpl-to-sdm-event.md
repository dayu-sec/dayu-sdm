...
| `extensions.source_private.syslog_priority/syslog_host/syslog_header_time` | `derived` | `raw_syslog.header` | `parse_syslog_header(raw_input.original_payload)` -> {"priority": 14, "host": "ngsoc93.qax.cn", "time": "Dec 18 16:01:32"} | `—` | confirmed；保留 Syslog 头审计值 |
