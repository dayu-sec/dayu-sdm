...
原始 Syslog KV 来自仓库 `s4-doris/models/wpl/ngsoc/sample.dat:34`。NGSOC 聚合观察到 `198.51.100.180` 向 `192.0.2.133:8200` 的 HTTP 相关内到外流量，并由来源规则定性为“慢速传输大量数据”；日志没有传输字节数、持续时间、速率或阈值。
