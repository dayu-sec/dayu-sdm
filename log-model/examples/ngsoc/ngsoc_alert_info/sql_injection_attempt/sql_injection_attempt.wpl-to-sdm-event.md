...
| `extensions.source_private.request_targets` | `transform` | `uri` | `parse_bracket_list(wpl.uri)` -> "[/login?url=http://sdm.example.internal/\"and(select*from(select/**/sleep(5))a/**/union/**/select+1)=\", /login?url=http://sdm.example.internal/'and(select*from(select/**/sleep(5))a/**/union/**/select+1)=', /login?url=http://sdm.example.internal//**/and(select*from(select+sleep(5)union/**/select+1)a), /apis/login, /api/strategys?pageSize=10&pageNumber=1&type=2&query=123'\"and(select*from(select/**/sleep(5))a/**/union/**/select+1)=\", /api/strategys?pageSize=10&pageNumber=1&type=2&query=123'/**/and(select*from(select+sleep(5)union/**/select+1)a), /api/strategys?pageSize=10&pageNumber=1&type=2&query=123''and(select*from(select/**/sleep(5))a/**/union/**/select+1)=', /api/strategys/ME454286696117313536/components?pageSize=10&pageNumber=1&type=2&query=123/**/and(select*from(select+sleep(5)union/**/select+1)a), /api/strategys/ME454286696117313536/components?pageSize=10&pageNumber=1&type=2&query=123\"and(select*from(select/**/sleep(5))a/**/union/**/select+1)=\", /api/strategys/ME454286696117313536/components?pageSize=10&pageNumber=1&type=2&query=123'and(select*from(select/**/sleep(5))a/**/union/**/select+1)=']" | `preserve_raw_and_review` | confirmed；解析 WPL 括号列表，保留各相对 URI，不拼造单一 URL |
...
| `roles.related[].domain.name` | `transform` | `domain` | `parse_bracket_list(wpl.domain)` -> "[sdm.example.internal, sdm.example.internal]" | `drop_invalid_items_and_review` | confirmed；解析域名列表，每项建立 related domain |
