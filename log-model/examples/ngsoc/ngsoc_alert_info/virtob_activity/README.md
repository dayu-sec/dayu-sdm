...
原始 Syslog KV 来自仓库 `s4-doris/models/wpl/ngsoc/sample.dat:45`。NGSOC 观测 `203.0.113.159` 与 `192.0.2.179` 的 DNS 相关通信，域名 IOC 为 `fei9988.3322.org`，恶意家族为 `Virtob`，聚合 `60` 次命中；没有 DNS 应答、传输协议或蠕虫传播成功证据。
