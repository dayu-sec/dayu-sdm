...
原始 Syslog KV 来自仓库 `s4-doris/models/wpl/ngsoc/sample.dat:31`。NGSOC 观测 `192.0.2.38` 与 `203.0.113.99` 的 DNS 相关通信，域名 IOC 为 `xred.mooo.com`，恶意家族为 `AsyncRAT`，聚合 `20` 次命中；没有 DNS 应答、传输协议或远控连接成功证据。
