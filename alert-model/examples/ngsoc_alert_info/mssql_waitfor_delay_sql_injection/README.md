# MSSQL Waitfor语句SQL注入攻击

由 `log-model/examples/ngsoc/ngsoc_alert_info/mssql_waitfor_delay_sql_injection/mssql_waitfor_delay_sql_injection.expected-sdm-event.json` 导入为平台 `SOURCE_ALERT`。
